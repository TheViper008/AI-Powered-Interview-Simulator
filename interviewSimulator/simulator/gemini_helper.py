...
JdPrompt = """
Here's text that has been extracted from a job description file, extract useful information from this text and generate a list of {} questions for the job described that are most likely to be asked in an interview.
